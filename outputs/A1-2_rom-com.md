...
### *Uma comédia romântica em gaveta fechada*
...
***ser*** — *to be (used for permanent characteristics, irregular)*

| Tense | Eu | Tu | Ele/Ela | Nós | Eles/Elas |
|---|---|---|---|---|---|
| Present | sou | és | é | somos | são |
| Past | fui | foste | foi | fomos | foram |
| Future | serei | serás | será | seremos | serão |
...
| Future | terei | terás | terá | teremos | terão |

---

***estar*** — *to be (used for states and conditions, irregular)*

| Tense | Eu | Tu | Ele/Ela | Nós | Eles/Elas |
|---|---|---|---|---|---|
| Present | estou | estás | está | estamos | estão |
| Past | estive | estiveste | esteve | estivemos | estiveram |
| Future | estarei | estarás | estará | estaremos | estarão |
